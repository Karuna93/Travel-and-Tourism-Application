...
public class BookPackage extends JFrame implements ActionListener {
    ...
    public void fetchCustomerDetails(String uname) {
        if (!uname.isEmpty()) {
            try {
                Conn c = new Conn();
                ...
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "No user found " + uname);
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == checkprice) {
            ...
            if (!isCustomerLoaded) { 
                JOptionPane.showMessageDialog(null, "Please log in before booking a package.");
                return;
            }
